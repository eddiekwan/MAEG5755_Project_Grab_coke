...
void set_example_object_frames(geometry_msgs::PoseStamped &object_poseStamped,
    ...
    object_poseStamped.pose.position.z = 0.84; //-0.125; //pose w/rt world frame
    object_poseStamped.pose.orientation.x = 0.63;
    object_poseStamped.pose.orientation.y = 0;
    object_poseStamped.pose.orientation.z = 0.63;
    object_poseStamped.pose.orientation.w = 0.44;
    ...
    object_dropoff_poseStamped.pose.position.x = 0.65;
    object_dropoff_poseStamped.pose.position.y = 0;
    object_dropoff_poseStamped.pose.position.z = 0.86;
