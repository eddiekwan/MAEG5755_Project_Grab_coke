...
void rethink_grasp_TOY_BLOCK_ID(int query_code, int grasp_option,
    ...
    object_pose_wrt_gripper.orientation.x = -0.707; //x-axis parallel, z-axis anti-parallel:
    object_pose_wrt_gripper.orientation.y = 0; //grasp from above
    object_pose_wrt_gripper.orientation.z = -0.707;
    object_pose_wrt_gripper.orientation.w = 0;
